export {
  TRANSCRIPT_KEEP_EDGE_SNAP_SEC,
  snapTranscriptCaptionEdge,
  snapWordActionRangeToKeeps,
  snapWordBoundsToKeepEdges,
} from "~/domain/edit/snap";

/** Snap a timestamp to the nearest range start or end. */
...
/**
 * Timeline drags snap by default; hold Shift for continuous time.
 * Start handles prefer starts (captions + keeps); end handles prefer ends.
 */
